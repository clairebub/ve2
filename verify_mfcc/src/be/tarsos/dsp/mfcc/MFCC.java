...
public class MFCC implements AudioProcessor {
	...
	public boolean process(AudioEvent audioEvent) {
		...
		if (audioEvent.getSamplesProcessed() < 10) {
            System.out.println("deebug: audioFloatBuffer=");
            for (int i = 0; i < audioFloatBuffer.length; i++) {
                System.out.print(audioFloatBuffer[i] + ", ");
            }
            System.out.println();
        }
		//System.out.println();
        ...
        if (audioEvent.getSamplesProcessed() < 10) {
            System.out.print("deebug: mfc=");
            for (int i = 0; i < 3; i++) {
                System.out.print(" " +mfcc[i]);
            }
            System.out.println();
        }
